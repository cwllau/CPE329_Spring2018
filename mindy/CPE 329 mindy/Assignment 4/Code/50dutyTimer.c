...
int main(void) {
    ...
    P1->SEL1 &= ~BIT0;
    P1->SEL0 &= ~BIT0;
	P1->DIR |= 3;                        // P1.0 output
	
	//Configure MCLK according to datasheet pg 151
	P4->SEL1 &= ~BIT3;
	P4->SEL0 |= BIT3;
	P4->DIR |= BIT3;
    ...
    TIMER_A0->CCR[0] = 480; //Set CCR0 to 240 for on cycle
...
void TA0_0_IRQHandler(void) {
	...
	TIMER_A0->CCR[0] += 480; //increment timer
	P1->OUT ^= BIT0; //turn led on/off
